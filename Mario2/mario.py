    ...
    def update(self, direction=None):
        ...
        if direction:
            if direction == 'L' and 0 <= self.rect.move(-tile_width, 0).left <= width\
                    and level_map[start_y][start_x - 1] in '.@':
                self.lastrectx = self.rect.topleft[1]
             #   if level_map[start_y][start_x - 1] != '#':
              #      level_map[start_y] = level_map[start_y][:start_x - 1] + '@' + '.' + level_map[start_y][start_x + 1:]
                print(level_map[start_y])
                start_x = start_x - 1
            ...
            #    level_map[start_y] = level_map[start_y][:start_x - 1] + '.' + '@' + level_map[start_y][start_x + 1:]
                ...
                self.move = True
                    ...
                    and level_map[start_y - 1][start_x] in '.':
                level_map[start_y] = level_map[start_y][:start_x] + '.' + level_map[start_y][start_x + 1:]
                level_map[start_y - 1] = level_map[start_y - 1][:start_x] + '@' + level_map[start_y - 1][start_x + 1:]
                start_y = start_y - 1
